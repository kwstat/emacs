;; pastel-themes.el
;; Copyright Kevin Wright, MIT license

;; Useful for interpolating colors:
;; https://meyerweb.com/eric/tools/color-blend

;; Useful for changing HSV
;; https://www.hexcolortool.com


;; pastel-themes.el is derived from base16-theme.el
...
;; This is just a quick view of the colors used in the definitions below
;; "#fae6e6" "#ffece0" "#fdfde7" "#f0fff0" "#d9e9ff" "#edebff" "#f4f4f4" "#1c2023"
;; "#eed3d3" "#f0cab3" "#d5d5b9" "#e0f0e0" "#b4cae6" "#c6c2e5" "#d1d1d1" "#393f45"
;; "#c89797" "#e1a886" "#c1ac8b" "#abbfab" "#8faccc" "#9e9acb" "#aeaeae" "#565e65"
;; "#b06f6f" "#d1855a" "#a2845c" "#899f89" "#6a8db3" "#7771b2" "#8b8b8b" "#747c84"
;; "#974848" "#c2632d" "#845b2e" "#677f67" "#456f99" "#4f499b" "#696969" "#adb3ba"
;; "#7e2020" "#b34100" "#663300" "#455f45" "#205080" "#28207e" "#464646" "#c7ccd1"
;; "#3f1010" "#5a2100" "#331a00" "#223f22" "#1f292e" "#201f2e" "#232323" "#dfe2e5"
;; "#000000" "#000000" "#000000" "#000000" "#000000" "#000000" "#000000" "#f3f4f5"
;;                                                                       "#c7ae95"
;;                                                                       "#c7c795"
;;                                                                       "#aec795"
;;                                                                       "#95c7ae"
...
(defvar pastel-red-colors
  ...
  "All colors for pastel-red are defined here.")

(defvar pastel-orange-colors
  '(:base00 "#ffece0"
    :base01 "#f8dccb"
    :base02 "#e1a886"
    :base03 "#d1855a"
  ...
  "All colors for pastel-orange are defined here.")

(defvar pastel-yellow-colors
  '(:base00 "#fdfde7" ;46 100 88 "#fdfde7"
    :base01 "#fbf7c4" ;39 64 77 "#fbf7c4"
    :base02 "#d5b080" ;34 50 67 "#c1ac8b"
    :base03 "#c09060" ;30 43 56 "#a2845c"
    :base04 "#947249" ;33 34 43 "#845b2e"
    :base05 "#573700" ;38 100 17 "#663300"
    :base06 "#331a00"
    :base07 "#000000"
    :base08 "#860026" 
    :base09 "#602900" 
  ...
  "All colors for pastel-yellow are defined here.")

(defvar pastel-brown-colors
  '(:base00 "#f0e7de" ;35 43 91 "#e6d8bc" ;46 100 88
    :base01 "#e9dbc8" ;35 43 85 "#fbf7c4"
    :base02 "#d5b080" ;34 50 67 "#c1ac8b"
    :base03 "#c09060" ;30 43 56 "#a2845c"
    :base04 "#947249" ;33 34 43 "#845b2e"
    :base05 "#573700" ;38 100 17 "#663300"
  ...
  "All colors for pastel-brown are defined here.")

(defvar pastel-green-colors
  '(:base00 "#f0fff0" ; 120 100 97
    :base01 "#e0f0e0" ; 151 100 94
    :base02 "#abbfab"
    :base03 "#899f89"
    :base04 "#677f67"
    :base05 "#455f45"
  ...
  "All colors for pastel-green are defined here.")

(defvar pastel-blue-colors
  '(:base00 "#d9e9ff"
    :base01 "#c8daf3"
    :base02 "#8faccc"
    :base03 "#6a8db3"
  ...
  "All colors for pastel-blue are defined here.")

(defvar pastel-purple-colors
  '(:base00 "#edebff" 
    :base01 "#dbd8f3" ; "#c6c2e5" 
    :base02 "#9e9acb" 
    :base03 "#7771b2" 
    :base04 "#4f499b" 
    :base05 "#28207e" 
...
(defvar pastel-gray-colors
  '(:base00 "#f4f4f4"
    :base01 "#e4e4e4" ; "#d1d1d1"
    :base02 "#aeaeae"
    :base03 "#8b8b8b"
    :base04 "#696969"
    :base05 "#464646"
...
(defun base16-theme-define (theme-name theme-colors)
  ...
  (base16-set-faces
   ...
   '(
     ...
     (default                                      :foreground base07 :background base00)
     (fringe                                       :background base01)
     (gui-element                                  :background base01)
     (header-line                                  :inherit mode-line-inactive)
     ...
     (region                                       :background base01 :distant-foreground base05)
     ...
     (font-lock-comment-face                       :foreground base05 :italic t) 
     ...
     (font-lock-keyword-face                       :foreground base0F :weight bold)
...
;;     (swiper-packground-match-face-1 :weight bold :foreground base0A :background base02)
     ...
     ;; mode-line
     ;; Make mode-line appear taller by using a wide border of the same color
     (mode-line                                    :foreground base00 :background base05 :box (:line-width 3 :color base05))
     (mode-line-inactive                           :foreground base05 :background base01 :box (:line-width 1 :color base05))
     ...
     ;; dired
     (dired-filetype-plain                         :inherit default) ;; default
     (dired-filetype-source                        :foreground base06)
     ...
     ;; flyspell-mode
     (flyspell-duplicate                           :underline (:style line :color base09))
     (flyspell-incorrect                           :underline (:style line :color base08) :weight bold)
...
;     (helm-ff-dirs) ;; already inherited
     ...
     (markdown-header-face-1                       :foreground base0B :height 1.4 :weight bold :overline base01)
     (markdown-header-face-2                       :foreground base0D :height 1.3 :weight bold :overline base01)
     (markdown-header-face-3                       :foreground base08 :height 1.2 :weight bold :overline base01)
     (markdown-header-face-4                       :foreground base09 :height 1.1 :weight bold :overline base01)
     ;; metadata faces are used in the yaml section
     (markdown-metadata-key-face                   :foreground base09)
     (markdown-metadata-value-face                 :foreground base07)
     ;; I *think* the darker background of YAML blocks is coming from
     ;; markdown-syntax-propertize-yaml-metadata
     ...
     ;; rainbow-delimiters
     ;; These colors taken from "spring". Intentionally NOT in a rainbow sequence
     (rainbow-delimiters-depth-1-face              :inherit default)
     (rainbow-delimiters-depth-2-face              :foreground "#901010")
     (rainbow-delimiters-depth-3-face              :foreground "#0000f0")
     (rainbow-delimiters-depth-4-face              :foreground "#ff7000")
     (rainbow-delimiters-depth-5-face              :foreground "#006000")
     (rainbow-delimiters-depth-6-face              :foreground "#8000a0")
     (rainbow-delimiters-depth-7-face              :foreground "#947249")
     (rainbow-delimiters-depth-8-face              :foreground "#4982aa")
     (rainbow-delimiters-depth-9-face              :foreground "#d797a0")
     (rainbow-delimiters-unmatched-face            :foreground "black" :background "yellow")
...
(provide 'pastel-themes)

;;; pastel-themes.el ends here
