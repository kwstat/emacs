;; winter-theme.el
;; A dark-on-light-blue theme.

;; MIT license. Copyright (c) Kevin Wright.

(deftheme winter "The colors of winter (light yellow background).")
...
(let ((gray-9   "#eeeeee")
      ...
      (ol1 '(:foreground "#0000f0" :background "#cee7ff" :height 1.3 :weight bold :overline "#000060"))
      (ol2 '(:foreground "#006000" :background "#dbf7c0" :weight bold ))
      (ol3 '(:foreground "#901000" :background "#f0c0d0" :weight bold ))
...
(custom-theme-set-faces
 ...
 ;;; Basic UI
 `(default ((t (:foreground ,gray-1 :background "#d9e9ff")))) ; cee7ff
 `(button ((t (:foreground ,blue-1 :underline t))))
 `(cursor ((t (:foreground ,gray-8 :background ,gray-2))))
 `(fringe ((t (:foreground, blue-3 :background ,blue-4))))
 `(minibuffer-prompt ((t (:foreground ,blue-1 :background ,blue-5 :weight bold))))
 `(mode-line ((t (:foreground ,blue-5 :background ,blue-2
                              :box (:line-width 1 :color ,blue-3 :style released-button)))))
 `(mode-line-inactive ((t (:foreground ,blue-1 :background ,gray-8))))
 ...
 ;; eshell
 `(eshell-prompt ((t (:foreground "#901000" :weight bold))))
 
 ;; ess
 `(ess-debug-current-debug-line-face ((t (:background ,green-4)))) ; region
 ...
 `(font-lock-comment-face ((t (:foreground ,blue-2 :italic t))))
 `(font-lock-comment-delimiter-face ((t (:foreground ,gray-5))))
 ...
 `(font-lock-type-face ((t (:foreground ,tan-2 :weight bold))))
 ...
 `(compilation-error ((t (:foreground ,red-1 :background ,red-5 :weight bold))))
 ...
 ;; markdown
 ;;`(markdown-header-delimiter-face ((t (:foreground ,gray-1 :weight bold))))
...
; `(org-date ((t (:foreground "#ebbbff"))))
 `(org-document-title ((t (:foreground ,gray-3 :height 1.6 :weight bold))))
 ...
 ;; which
 `(which-func ((t (:foreground , purple-5))))
