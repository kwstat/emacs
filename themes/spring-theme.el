...
(deftheme spring "The colors of spring (light yellow background).")
...
(let ((gray-9   "#eeeeee")
      ...
      (ol1 '(:foreground "#006000" :background "#dbf7c0" :height 1.3 :weight bold :overline "#006000"))
...
(custom-theme-set-faces
 ...
 ;;; Basic UI
 `(default ((t (:foreground ,gray-1 :background "honeydew"))))
 `(button ((t (:foreground ,blue-1 :underline t))))
 `(cursor ((t (:foreground ,gray-8 :background ,gray-2))))
 `(fringe ((t (:foreground, green-3 :background ,green-5))))
 `(minibuffer-prompt ((t (:foreground ,blue-1 :background ,blue-5 :weight bold))))
 `(mode-line ((t (:foreground ,green-5 :background ,green-2
                  :box (:line-width 1 :color ,green-3)))))
 `(mode-line-inactive ((t (:foreground ,green-1 :background ,gray-8
                           :box (:line-width 1 :color ,green-3)))))
 `(region ((t (:background ,green-4))))
 ...
 `(font-lock-comment-face ((t (:foreground ,gray-5 :italic t))))
 `(font-lock-comment-face ((t (:foreground ,tan-1 :italic t))))
 ;`(font-lock-comment-face ((t (:foreground ,gray-6 :italic t))))
 ;`(font-lock-comment-delimiter-face ((t (:foreground ,gray-6))))
