...
(autothemer-deftheme
 ...
 (
  ;; Basic UI
  (default            (:foreground gray-0 :background "honeydew"))
  (button             (:foreground blue-1 :underline t))
  (cursor             (:foreground gray-8 :background gray-2))
  (fringe             (:foreground green-3 :background green-5))
  (minibuffer-prompt  (:foreground blue-1 :background blue-5 :bold t))
  (mode-line          (:foreground green-5 :background green-2 :box (:line-width 1 :color green-3)))
  (mode-line-inactive (:foreground green-1 :background gray-8 :box (:line-width 1 :color green-3)))
  (region             (:background green-4))
