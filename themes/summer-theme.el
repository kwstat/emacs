...
(autothemer-deftheme
 ...
 (  
  ;; Basic UI
  ;; spring (:foreground gray-0 :background "honeydew")
  ;; summer (:foreground gray-0 :background "#fdfde7")
  ;; winter (:foreground gray-0 :background "#d9e9ff")
  
 (default  (:foreground gray-0 :background "#fdfde7"))
 (button  (:foreground blue-1 :underline t))
 (cursor  (:foreground gray-8 :background gray-2))
 (fringe  (:foreground yellow-3 :background yellow-5))
 (minibuffer-prompt  (:foreground tan-5 :background tan-0 ))
 (mode-line  (:foreground tan-0 :background yellow-2
              :box (:line-width 2 :color yellow-3)))
 (mode-line-inactive  (:foreground tan-0 :background gray-8))
 (region  (:background yellow-4))
 ...
 (markdown-metadata-value-face   (:bold t :foreground "black")
